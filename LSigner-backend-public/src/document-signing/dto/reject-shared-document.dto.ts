...
export class RejectSharedDocumentDto {
  @ApiPropertyOptional({
    description: 'Verification method used to authorize rejection',
  ...
  @ApiPropertyOptional({
    description: 'Optional reason provided by the recipient',
    example: 'Need legal review before signing.',
    maxLength: 1000,
  })
  @Transform(trim)
  @IsString()
